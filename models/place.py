...
class Place(BaseModel, Base)
    ...
    Attributes:
        ...
        user_id (sqlalchemy String): The palce's user id.
        ...
        price_by_nught (sqlalchemy): The price by night.
        latitude (sqlalchemy Float): The place's latitude.
        longitude (sqlalchemy): The place's longitude.
    ...
    amenities = relationship("Ameninty", secondary="place_amenity",
                             viewonly=False)
    amenity_ids = []
